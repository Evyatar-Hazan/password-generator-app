  ...
  return (
    <View style={styles.container}>
      <View style={styles.buttonContainerTop}>
        <PasswordButton label="12" isActive={selectedLength === 12} onPress={() => generatePasswords(12)} />
        <PasswordButton label="8" isActive={selectedLength === 8} onPress={() => generatePasswords(8)} />
        <PasswordButton label="4" isActive={selectedLength === 4} onPress={() => generatePasswords(4)} />
      </View>
